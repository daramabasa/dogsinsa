...
<style>
	#listForm {
		...
		.td_command { text-align: right; }
		#todayImageList { text-align: center; }
		#productImage { width: 150px; height: 150px; border: none; }
		#cartImage { width: 70px; height: 70px; border: none; }
		#select { text-align: right; }
		#commandList { text-align: center; }
		#upImage { width: 15px; }
		#downImage { width: 15px; }
</style>
<script>
...
function checkQty(name, qty) {
	if(qty != 1) {
		location.href = "dogCartQtyDown.dog?name=" + name;
	}
}
</script>
</head>
				...
				<table>
					...
					<c:forEach var="cart" items="${cartList }" varStatus="status">
						...
						<tr>
							...
							<td>
								<a href="dogCartQtyUp.dog?name=${cart.name }">
